...
const AddQuestion = () => {
    ...
    const handleRemoveChoice = (index) => {
        setChoices(choices.filter((choice, i) => i !== i))
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = {
                question, questionType, choices, correctAnswers: correctAnswers.map((answer) => {
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <form onSubmit={handleSubmit} className='p-2'>
                                ...
                                {!correctAnswers.length && <p>Please Enter at least on correct answer.</p>}
